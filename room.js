...
/**
 * Returns this browser's stable anonymous ID (the same one used for
 * room slot ownership), creating it on first call. Exposed for other
 * per-user, non-room features (e.g. the personal library) that need a
 * stable identity but must not claim a room slot to get one.
 */
